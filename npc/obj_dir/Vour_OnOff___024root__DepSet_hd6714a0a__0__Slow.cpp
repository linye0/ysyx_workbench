...
VL_ATTR_COLD void Vour_OnOff___024root___eval_static(Vour_OnOff___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vour_OnOff__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vour_OnOff___024root___eval_static\n"); );
}
...
VL_ATTR_COLD void Vour_OnOff___024root___eval_final(Vour_OnOff___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vour_OnOff__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vour_OnOff___024root___eval_final\n"); );
}
...
#endif  // VL_DEBUG
VL_ATTR_COLD void Vour_OnOff___024root___eval_stl(Vour_OnOff___024root* vlSelf);
...
VL_ATTR_COLD void Vour_OnOff___024root___eval_settle(Vour_OnOff___024root* vlSelf) {
    ...
    while (__VstlContinue) {
        __VstlContinue = 0U;
        Vour_OnOff___024root___eval_triggers__stl(vlSelf);
...
#endif
                VL_FATAL_MT("vsrc/our_OnOff.v", 1, "", "Settle region did not converge.");
            }
            vlSelf->__VstlIterCount = ((IData)(1U) 
                                       + vlSelf->__VstlIterCount);
            Vour_OnOff___024root___eval_stl(vlSelf);
        }
    }
}
...
VL_ATTR_COLD void Vour_OnOff___024root___dump_triggers__stl(Vour_OnOff___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vour_OnOff__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vour_OnOff___024root___dump_triggers__stl\n"); );
    // Body
...
void Vour_OnOff___024root___ico_sequent__TOP__0(Vour_OnOff___024root* vlSelf);

VL_ATTR_COLD void Vour_OnOff___024root___eval_stl(Vour_OnOff___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vour_OnOff__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vour_OnOff___024root___eval_stl\n"); );
    // Body
    if (vlSelf->__VstlTriggered.at(0U)) {
...
VL_ATTR_COLD void Vour_OnOff___024root___dump_triggers__ico(Vour_OnOff___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vour_OnOff__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vour_OnOff___024root___dump_triggers__ico\n"); );
    // Body
...
VL_ATTR_COLD void Vour_OnOff___024root___dump_triggers__act(Vour_OnOff___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vour_OnOff__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vour_OnOff___024root___dump_triggers__act\n"); );
    // Body
...
VL_ATTR_COLD void Vour_OnOff___024root___dump_triggers__nba(Vour_OnOff___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vour_OnOff__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vour_OnOff___024root___dump_triggers__nba\n"); );
    // Body
